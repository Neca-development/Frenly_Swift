...
public class CreateCommentTypedDataMutation: GraphQLMutation {
  public static let operationName: String = "CreateCommentTypedData"
  public static let document: DocumentType = .notPersisted(
    definition: .init(
      """
      mutation CreateCommentTypedData($profileId: ProfileId!, $publicationId: InternalPublicationId!, $contentURI: Url!) {
        createCommentTypedData(
          request: {profileId: $profileId, publicationId: $publicationId, contentURI: $contentURI, collectModule: {revertCollectModule: true}, referenceModule: {followerOnlyReferenceModule: false}}
        ) {
          __typename
          id
          expiresAt
  ...
  public struct Data: LensProtocol.SelectionSet {
    ...
    public static var __selections: [Selection] { [
      .field("createCommentTypedData", CreateCommentTypedData.self, arguments: ["request": [
    ...
    public var createCommentTypedData: CreateCommentTypedData { __data["createCommentTypedData"] }

    /// CreateCommentTypedData
    ///
    /// Parent Type: `CreateCommentBroadcastItemResult`
    public struct CreateCommentTypedData: LensProtocol.SelectionSet {
      public let __data: DataDict
      public init(data: DataDict) { __data = data }

      public static var __parentType: ParentType { LensProtocol.Objects.CreateCommentBroadcastItemResult }
      public static var __selections: [Selection] { [
      ...
      /// CreateCommentTypedData.TypedData
      ///
      /// Parent Type: `CreateCommentEIP712TypedData`
      public struct TypedData: LensProtocol.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }

        public static var __parentType: ParentType { LensProtocol.Objects.CreateCommentEIP712TypedData }
        public static var __selections: [Selection] { [
        ...
        /// CreateCommentTypedData.TypedData.Types
        ///
        /// Parent Type: `CreateCommentEIP712TypedDataTypes`
        public struct Types: LensProtocol.SelectionSet {
          public let __data: DataDict
          public init(data: DataDict) { __data = data }

          public static var __parentType: ParentType { LensProtocol.Objects.CreateCommentEIP712TypedDataTypes }
          public static var __selections: [Selection] { [
            .field("CommentWithSig", [CommentWithSig].self),
          ] }

          public var commentWithSig: [CommentWithSig] { __data["CommentWithSig"] }

          /// CreateCommentTypedData.TypedData.Types.CommentWithSig
          ///
          /// Parent Type: `EIP712TypedDataField`
          public struct CommentWithSig: LensProtocol.SelectionSet {
            public let __data: DataDict
            public init(data: DataDict) { __data = data }
        ...
        /// CreateCommentTypedData.TypedData.Domain
        ///
        ...
        /// CreateCommentTypedData.TypedData.Value
        ///
        /// Parent Type: `CreateCommentEIP712TypedDataValue`
        public struct Value: LensProtocol.SelectionSet {
          public let __data: DataDict
          public init(data: DataDict) { __data = data }

          public static var __parentType: ParentType { LensProtocol.Objects.CreateCommentEIP712TypedDataValue }
          public static var __selections: [Selection] { [
